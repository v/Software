...
class NewLineDetectorNode2(EasyNode):
    def __init__(self):
        ...
        self.pub_edge = rospy.Publisher("~edge", Image, queue_size=1)  # @UndefinedVariable
        self.pub_color_segment = rospy.Publisher("~colorSegment", Image, queue_size=1)  # @UndefinedVariable        
    ...
    def on_received_switch(self, switch_msg):
        self.active = switch_msg.data

    def on_received_image(self, image_msg):
        self.stats.received()
    ...
    def on_received_transform(self, transform_msg):
...
#         if self.config.verbose:
            ...
            self.pub_color_segment.publish(colorSegment_msg_out)
